    ...
    <Card>
      ...
      }
      {
        ...
        <OrderItemButtonContainer>
          ...
          <Button $buttonstyle={`${ORDERSTATUS.CANCELLED}`} onClick={() => dispatch(assignStatusInCancelled(order.id))}>Cancelled</Button>
        </OrderItemButtonContainer>
      ...
      }
      {
        ...
        <OrderItemButtonContainer>
          <Button $buttonstyle={`${ORDERSTATUS.COMPLETED}`} onClick={() => dispatch(assignStatusInCompleted(order.id))}>Completed</Button>
          <Button $buttonstyle={`${ORDERSTATUS.CANCELLED}`} onClick={() => dispatch(assignStatusInCancelled(order.id))}>Cancelled</Button>
        </OrderItemButtonContainer>
      }
    </Card>
